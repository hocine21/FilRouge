 ...
 */
final class Version20240613101056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture ADD commande_id INT DEFAULT NULL, DROP montant_total');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture ADD montant_total DOUBLE PRECISION NOT NULL, DROP commande_id');
    }
}
